...
# df = df[((df['day'] == 1) | (df['day'] == 2) | (df['day'] == 8) | (df['day'] == 9) | (df['day'] == 7) | (df['day'] == 14) | (df['day'] == 15) | (df['day'] == 16) ) & ( (df['hour'] == 10) | (df['hour'] == 11) | (df['hour'] == 8) | (df['hour'] == 9) | (df['hour'] == 12) )]
# df = df[((df['day'] == 1) | (df['day'] == 2)) & ( (df['hour'] == 10) | (df['hour'] == 11) )]
# df = df[:100000]
# df.to_hdf('/data/MaoXiaowei/ODTUQ_0702/DiffRoute/processed_data/raw/chengdu_d12897141516_h89101112.h5', key='df', mode='w')
loaded_data = pd.read_hdf('/data/MaoXiaowei/ODTUQ_0702/DiffRoute/processed_data/raw/chengdu_d12897141516_h89101112.h5', key='df')
print('number of traj points: ', len(loaded_data))
print('number of trajs: ', len(loaded_data.groupby(1)))
